    ...
    <body>
        ...
        <div class="section">
            ...
            <div class="container">
                ...
                <div class="row">
                    <!-- ASIDE -->
                    <div id="aside" class="col-md-3" style="float: left">
                        <!-- aside widget -->
                    ...
                    <div id="main" class="col-md-9">
                        ...
                        <!-- STORE -->
                        <div id="store" style="border: none; padding-left: 50px;">
                            <!-- row -->
                            <div class="row">
                                <!-- Product Single -->
                                <%  productDB pdb = new productDB();
                                    ArrayList<Phone> list = pdb.getProdustDealsS();
                                    for (int i = 0; i < list.size(); i++) {
                                      
                                %>    

                                 <%  int discount = pdb.getDiscount(list.get(i).getID());
                                     int newPrice = (list.get(i).getPrice() * (100 - discount)) / 100;
						...
						<span class="sale">-<%=discount %>%</span>
                                            ...
                                            <img src="<%=list.get(i).getImg()%>" style="width: 212px; height: 169px;" alt="">
                                        </div>
                                        <div class="product-body">
                                           
                                            <h3 class="product-price"><%=newPrice %> VNĐ <del class="product-old-price"><%=list.get(i).getPrice() %></del></h3>
